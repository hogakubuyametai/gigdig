  ...
  <div
    ...
    >
      <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 p-4 sm:p-6 relative">
        ...
        <button
          type='button'
          class='cursor-pointer absolute top-2 sm:top-3 right-3 sm:right-4 text-white text-2xl sm:text-3xl font-bold hover:text-gray-200'
          @click='handleCloseModal'
        >
          ×
        </button>
      ...
      <form @submit='handleSubmit' class='p-4 sm:p-6 space-y-4'>
        ...
        <button
          type='submit'
          class='w-full bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-2.5 sm:py-3 px-4 rounded-md transition-colors cursor-pointer mt-6 text-sm sm:text-base'
          aria-label="Add Gig"
          title="Add Gig"
        >
          Add
